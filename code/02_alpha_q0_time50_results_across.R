...
# need time on the original scale (not centred), and also the min and max time for each study for results plots
alpha_dat <- read.delim(paste0(path2wd, 'data/Rich-across.txt'),
                             sep = " ") %>% 
  as_tibble() %>% 

# alpha diversity before after results of model fit to data standardised within studies
...
# chains have mixed and converged adequately
...
# imodel reproduces the data well
